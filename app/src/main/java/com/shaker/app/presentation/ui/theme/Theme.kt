...
object ShakerTheme {
    val colors: ShakerColors
        @Composable
        get() = LocalShakerColors.current
}
...
class ShakerColors(
    ...
    fun copy(): ShakerColors = ShakerColors(
...
fun ProvideShakerColors(
    ...
    CompositionLocalProvider(LocalShakerColors provides colorPalette, content = content)
}
